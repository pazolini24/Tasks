...
icon_editar = PhotoImage(file="img\editar.png").subsample(3, 3)
icon_deletar = PhotoImage(file="img\excluir.png").subsample(3, 3)
...
botao_adicionar = tk.Button(frame, text="Adcionar Tarefa", command=adicionar_tarefa, bg= "#4CAF50", fg="white", height=1, width=15, font=("Roboto", 11), relief=tk.FLAT )
